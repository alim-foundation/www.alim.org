...
<span class="flag-wrapper flag-<?php echo $flag_name_css; ?>">
  <a href="<?php echo $link_href; ?>" title="<?php echo $link_title; ?>" title="<?php print $link_text;?>" class="popups" on-popups-options="{reloadWhenDone: true}" ><?php echo $link_text; ?></a><span class="flag-throbber">&nbsp;</span>
