...
?>
 <div style="padding-left:20px;color:#993300;"> <b><?php print $_SESSION['msg'];?> </b></div>
...
/* if(arg(7)==111){
 ...
 <span id="<?php print"comment-".$cid; ?>">
  ...
  <tr>
    ...
    <td  width="69"  class="cm_image" valign="top" style="padding-top:5px;" ><!--<img title="Community User" src="<?php print $img_theme_path; ?>/userimage.png" />-->
...
<?php 
} else if($temp_user->rpx_data['profile']['photo']!=""&&$dis==1&& $picture=="") {?><img height="38px"  width="48px" src="<?php print $temp_user->rpx_data['profile']['photo']; ?>" /><?php }
    else if($temp_user->rpx_data['profile']['photo']==""&&$dis==1&& $picture=="") {?><img src="<?php print $img_theme_path; ?>/photobg.png" /><?php } ?>
	</a>
...
?></div></div>
				 <span ><?php //print $body; ?>
			<div id="comment_body_scholar" style="padding-left:45px;" >	
				 <?php  // print_r($n); 
...
<?php
 ...
 /*88888888888888888888888888888888888888888888888888888*/
  ...
  if($value=="Community User" && $value!="Scholar" && $value!="Book Author"  ) {?> <table width="100%" border="0" style="border-color:#CCCCCC;margin-bottom:20px;border:solid #A0A0A0 1px;border-collapse:separate;"  ><tr><td>
  <table width="100%" border="0" cellpadding="0" style="border-collapse:separate;" >
  <tr>
    <td  width="69"  class="cm_image" valign="top" style="padding-top:5px;"   ><!--<img title="Community User" src="<?php print $img_theme_path; ?>/userimage.png" />-->
	<img style="padding-left:15px;" title="Community User" src="<?php print $img_theme_path; ?>/userimage.png" />
...
$node=$row['cid']; 
		 	$qry = "SELECT count(*) FROM {comments} where pid=$node";
	$num = db_result(db_query(db_rewrite_sql($qry)));
	//print $node.'--'.$num.'--'; 
...
/*$result=db_query("SELECT * FROM {comments} where pid=%d and nid=%d ORDER BY cid ASC ",$cid,$com_nodid);
while ($row = db_fetch_array($result)) {
...
$node=$row['cid']; 
		 ...
		 $result1=db_query("SELECT * FROM {comments} where pid=%d and nid=%d ORDER BY cid ASC ",$node,$com_nodid);
while ($row = db_fetch_array($result1)) {
...
$node1=$row['cid']; 
		 ...
		 $viewName = 'user_scholar_comments';
				 print views_embed_view($viewName , $display_id = 'default',$node1);
		 
		 
		  $result2=db_query("SELECT * FROM {comments} where pid=%d and nid=%d ORDER BY cid ASC ",$node1,$com_nodid);
...
<div style="padding-left:20px;color:#993300;"> <b><?php print $_SESSION['msg'];?> </b></div>
<span id="<?php print"comment-".$cid; ?>">
<?php  if($value!="Community User" && $value!="Scholar" && $value!="Book Author") { ?>
<table width="100%" border="0" style="border-color:#CCCCCC;margin-bottom:20px;border:solid #A0A0A0 1px;border-collapse:separate;"  >
<tr>
  <td><table width="100%" border="0" cellpadding="0" style="border-collapse:separate;" >
      <tr>
        <td  width="69" class="cm_image" valign="top" style="padding-top:5px;" ><img style="padding-left:15px;" title="Community User" src="<?php print $img_theme_path; ?>/userimage.png" />
          <div style="font-size:9px;color:#333333;font-weight:bold;padding-left:15px;">User</div>
          <?php if($user->uid&&$dis==1){ ?>
          <?php
print vud_widget_proxy($cid, 'comment', 'vote', 'plain', $readonly=NULL);
...
print vud_widget_proxy($cid, 'comment', 'vote', 'plain', $readonly=NULL);
?>
          <a  class="rpxnow" style="text-decoration:none;color:#333333;font-size:11px;" onclick="return false;" href="https://alim-foundation.rpxnow.com/openid/v2/signin?token_url=<?php print $base_url; ?>/rpx/end_point"> <img style="padding-right:5px;padding-left:5px;" src="<?php print $img_theme_path; ?>/likebut.jpg" /><img style="padding-right:5px;"  src="<?php print $img_theme_path; ?>/unlikebut.jpg" /></a> </span>
          <?php } }?>
        </td>
        <td  valign="top" bgcolor="#F7F7F7" ><div style="height:40px;color:#333333;padding-top:7px;padding-left:10px;font-size:12px;border-top:dotted 1px #cccccc;">
            <div style="width:450px;padding-bottom:10px;" ><span style="display:block;float:left;"> <a href="<?=$base_url?>/userprofile/<?=strip_tags($name)?>" class="gotouser">
              <?php if($picture!="") { ?>
              <img  src="<?=$base_url?>/<?=$picture?>"  height="32" width="32" align="absmiddle" alt="image" />
              <?php 
}  else if($temp_user->rpx_data['profile']['photo']!=""&&$dis==1&& $picture=="") {?>
              <img height="38px"  width="48px" src="<?php print $temp_user->rpx_data['profile']['photo']; ?>" />
              <?php }  else if($temp_user->rpx_data['profile']['photo']==""&&$dis==1&& $picture=="") {?>
              <img src="<?php print $img_theme_path; ?>/photobg.png" />
              <?php } ?>
              </a>
              <?php if($dis==0) {?>
              <img src="<?php print $img_theme_path; ?>/reported-as-inappropriate.png" />
              <?php } ?>
              </span><b>
              <?php if($dis==1){ ?>
              <a href="<?=$base_url?>/userprofile/<?=strip_tags($name)?>" class="gotouser">
	...
	print "&nbsp;&nbsp;".$fullname;
	 ...
	 print "&nbsp;&nbsp;".$temp_user->rpx_data['profile']['name']['givenName']." ".$temp_user->rpx_data['profile']['name']['familyName']."&nbsp;&nbsp;";
 	 ...
 	 ?>
              ...
              <?php $result = db_fetch_object(db_query("SELECT * FROM {alim_commentedurl} WHERE  cid = %d", $cid)); ?>
              <?php $count = db_affected_rows($result); ?>
              <?php if((($result->cid)!='') && ($dis==1)) { ?>
              <span style="color:#339933;"><br />
              &nbsp;&nbsp;Edited<?php print " (".$count.")"; ?></span>&nbsp;&nbsp;<?php print  time_since($uptime)." ago "; ?>
              <?php } else { ?>
              &nbsp;
              <?php if($dis==1){ ?>
              <br />
...
$rrtt="ctdef1".$cid;  $idval = 'ctdef1-'.$cid;?>
          <div id="comment_reply_comm" style="border-bottom:dotted 1px #cccccc;"  >
            <?php	if ($user->uid&&$dis==1){ ?>
            <span style="font-size:11px;"><a href="<?php print $base_url ?>/comment/reply/<?php print $com_nodid; ?>/<?php print $cid; ?>" class="popups" on-popups-options="{reloadWhenDone: true}"  style="text-decoration:none;font-size:11px;"><img align="absmiddle" src="<?php print $img_theme_path; ?>/ico_reply.gif" />&nbsp;Reply</a></span>
            <?php if(($userid)==($user->uid)){ ?>
            &nbsp;|&nbsp;<span style="font-size:11px;"><a href="<?php print $base_url ?>/comment/edit/<?php print $cid; ?>/comid" class="popups" on-popups-options="{reloadWhenDone: true}"  style="text-decoration:none;font-size:11px;"><img align="absmiddle" src="<?php print $img_theme_path; ?>/icon_edit_comment.png" />&nbsp;Edit</a></span>
            <?php } ?>
            &nbsp;|&nbsp;<span style="font-size:11px;"><img align="absmiddle" src="<?php print $img_theme_path; ?>/ico_flag.gif" />&nbsp;<?php print  $report; ?></span> &nbsp;|&nbsp;<span style="font-size:11px;"><a href="<?php print $base_url ?>/node/163673/<?php print $cid; ?>" class="popups-form-reload" on-popups-options="{reloadWhenDone: true}"  style="text-decoration:none;font-size:11px;"><img align="absbottom" src="<?php print $img_theme_path; ?>/ico_email.gif" />Email this</a></span>
            <?php } else {
...
?>
            ...
            &nbsp;|&nbsp;<span style="font-size:11px;"><a href="<?php print $base_url ?>/comment/edit/<?php print $cid; ?>/comid" class="popups" on-popups-options="{reloadWhenDone: true}"  style="text-decoration:none;font-size:11px;"><img align="absmiddle" src="<?php print $img_theme_path; ?>/icon_edit_comment.png" />&nbsp;Edit</a></span>
            <?php } ?>
            &nbsp;|&nbsp;<img align="absmiddle" src="<?php print $img_theme_path; ?>/ico_flag.gif" /><a  class="rpxnow" style="text-decoration:none;font-size:11px;" onclick="return false;" href="https://alim-foundation.rpxnow.com/openid/v2/signin?token_url=<?php print $base_url; ?>/rpx/end_point">&nbsp;Report Inappropriate</a> &nbsp;|&nbsp;<a  class="rpxnow" style="text-decoration:none;font-size:11px;" onclick="return false;" href="https://alim-foundation.rpxnow.com/openid/v2/signin?token_url=<?php print $base_url; ?>/rpx/end_point"><img align="absbottom" src="<?php print $img_theme_path; ?>/ico_email.gif" />Email this</a>
            <?php }
...
if($value=="Community User" && $value!="Scholar" && $value!="Book Author") { ?>
    <table width="100%" border="0" style="border-color:#CCCCCC;margin-bottom:20px;border:solid #A0A0A0 1px;border-collapse:separate;"  >
    <tr>
      <td><table width="100%" border="0" cellpadding="0" style="border-collapse:separate;" >
          <tr>
            <td  width="69"  class="cm_image" valign="top" style="padding-top:5px;"   >
              <img style="padding-left:15px;" title="Community User" src="<?php print $img_theme_path; ?>/userimage.png" />
              <div style="font-size:9px;color:#333333;font-weight:bold;padding-left:15px;">User</div>
              <?php	if ($user->uid&&$dis==1){ ?>
              <?php
...
if($value=="Scholar") {
?>
        <table width="100%" border="0" style="border-color:#ECECEC;margin-bottom:20px;border:solid #A0A0A0 1px;border-collapse:separate;"  >
        <tr>
          <td><table width="100%" border="0" cellpadding="0" style="border-collapse:separate;" >
              <tr>
                <td width="69" valign="top" class="so_image" style="padding-top:5px;" ><img style="padding-left:15px;" title="Scholar" src="<?php print $img_theme_path; ?>/scollerimage.png" />
...
?>
                ...
                <td  valign="top" bgcolor="#fcf7ec" ><div style="width:<?php print $padd3.'px' ?>;height:40px;padding-top:7px;padding-left:10px;font-size:12px;margin-left:<?php print $padd.'px' ?>;border-top:dotted 1px #cccccc;">
                    <div style="width:450px;float:left;padding-bottom:10px;" ><span style="display:block;float:left;"> <a href="<?=$base_url?>/userprofile/<?=strip_tags($name)?>" class="gotouser">
                      <?php if($picture!="") { ?>
                      <img  src="<?=$base_url?>/<?=$picture?>"  height="32" width="32" align="absmiddle" alt="image" />
                      <?php 
		} else if($temp_user->rpx_data['profile']['photo']!="") {?>
                      <img height="38px"  width="48px" src="<?php print $temp_user->rpx_data['profile']['photo']; ?>" />
                      <?php } 
		else if($temp_user->rpx_data['profile']['photo']=="") {?>
                      <img src="<?php print $img_theme_path; ?>/photobg.png" />
                      <?php } ?>
                      </a> </span><b> <a href="<?=$base_url?>/userprofile/<?=strip_tags($name)?>" class="gotouser">
                      <?php
	if($temp_user->rpx_data['profile']['name']['givenName']==""){
	print "&nbsp;&nbsp;".$fullname;
	}
	 ...
	 print "&nbsp;&nbsp;".$temp_user->rpx_data['profile']['name']['givenName']." ".$temp_user->rpx_data['profile']['name']['familyName']."&nbsp;&nbsp;";
 	 ...
 	 ?>
                      ...
                      <?php } else { ?>
                      &nbsp;<br />
                      &nbsp;&nbsp;<?php print  $created." ago "; } ?><span style="display:block;float:left;padding-top:10px;"></span></div>
                    <div id="comment_vote_scholar" style="float:right;padding-top:13px;padding-right:10px;">
                      <?
