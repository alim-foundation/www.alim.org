...
{
print "<div align='right' style='float:right;'><span style=color:#339933;>Edited (".$rev_count.") </span>  ".time_since($row4['changed'])." ago </div><br><br>";
}	
else
{
	print "<div align='right' style='float:right;'>".time_since($row4['created'])." ago </div><br><br>";
