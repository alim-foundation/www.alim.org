...
print views_embed_view($viewName1 , $display_id = 'default', arg(4), arg(5), 'ARB');*/
  ...
  $viewName = 'islamic_inroductory_article';

  $view_12 = views_get_view($viewName);
   $view_12->set_display('default');
   $view_12->set_arguments(array(arg(3),arg(4),arg(5)));
   $view_12->execute();
...
<img align="absmiddle" src="<?php print $img_theme_path; ?>/ico_reply.gif" />Reply&nbsp;|&nbsp;<img src="<?php print $img_theme_path; ?>/ico_flag.gif" />Report comment as inappropriate
