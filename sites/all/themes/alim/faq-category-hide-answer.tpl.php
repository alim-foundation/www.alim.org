...
//console.log("test1"+window.location.hash );
if(window.location.hash=='#Comments') {
$('.0-Comments').show();
//console.log("test2"+window.location.hash );
}
</script>
<div class="faq-category-group">
  ...
  <?php if (count($nodes)): ?>
    <?php foreach ($nodes as $i => $node): ?>
      ...
      <div class="faq-answer faq-dd-hide-answer <?=$i."-".$header_title?>">
      <?php print $node['body']; ?>
