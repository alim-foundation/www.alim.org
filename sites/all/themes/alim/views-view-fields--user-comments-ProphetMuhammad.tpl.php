...
<table width="100%" border="0" style="border-color:#CCCCCC;margin-bottom:20px;border:solid #666666 1px;border-collapse:separate;"  ><tr><td>
...
&nbsp;|&nbsp;<span style="font-size:11px;"><img src="<?php print $img_theme_path; ?>/ico_flag.gif" /><?php print  $report; ?></span>
...
&nbsp;|&nbsp;<img src="<?php print $img_theme_path; ?>/ico_flag.gif" /><a  class="rpxnow" style="text-decoration:none;font-size:11px;" onclick="return false;" href="https://alim-foundation.rpxnow.com/openid/v2/signin?token_url=<?php print $base_url; ?>/rpx/end_point">Report Inappropriate</a>
...
?>
    ...
    <table width="100%" border="0" style="border-color:#ECECEC;margin-bottom:20px;border:solid #666666 1px;border-collapse:separate;"  ><tr><td>
    <table width="100%" border="0" cellpadding="0" style="border-collapse:separate;" >
  <tr>
