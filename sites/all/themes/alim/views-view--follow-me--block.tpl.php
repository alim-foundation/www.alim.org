...
global $user;
 ...
 //Check user privacy settings of " Follower " List.
 $sel_follower  =  db_query("SELECT value as follower_sel, count(*) as follower_count FROM {profile_values} WHERE fid=%d AND uid=%d", 16, $user_uid);
...
?>
    ...
    {
	?>
	 User is hiding <br />the " Follower List ".
	<?php
	}
	else
	{
	?>
	 You are hiding <br />the " Follower List ".
	<?php
	}
	?>
    </div>
