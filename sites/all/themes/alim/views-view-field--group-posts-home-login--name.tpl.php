...
// Home page recent group post block logined . Shows the user picture and full name from rpx data. User image and name linked to user profile page.
...
?>
<a href="<?=$base_url?>/userprofile/<?=strip_tags($output)?>" class="gotouser" style="color:#660000">
<div id="user_image">
