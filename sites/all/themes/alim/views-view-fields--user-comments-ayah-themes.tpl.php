...
print views_embed_view($viewName1 , $display_id = 'default', arg(4), arg(5), 'ARB');*/
  ...
  $viewName = 'ayah_theme_list_for_comment';

  $view_12 = views_get_view($viewName);
   $view_12->set_display('default');
   $view_12->set_arguments(array(arg(4)));
   $view_12->execute();
...
<?php 
} else if($temp_user->rpx_data['profile']['photo']!=""&&$dis==1&& $picture=="") {?><img height="38px"  width="48px" src="<?php print $temp_user->rpx_data['profile']['photo']; ?>" /><?php }  else if($temp_user->rpx_data['profile']['photo']==""&&$dis==0&& $picture=="") {?><img src="<?php print $img_theme_path; ?>/photobg.png" /><?php } ?>
	</a>
...
&nbsp;|&nbsp;<a  class="rpxnow" style="text-decoration:none;font-size:11px;" onclick="return false;" href="https://alim-foundation.rpxnow.com/openid/v2/signin?token_url=<?php print $base_url; ?>/rpx/end_point"><img align="absbottom" src="<?php print $img_theme_path; ?>/ico_email.gif" />Email this</a></span>
