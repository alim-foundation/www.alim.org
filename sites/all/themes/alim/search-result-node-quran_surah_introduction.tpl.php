...
$urlto = 'library/quran/surah/introduction/'.$node_result->field_surah_no[0]['value'].'/'.$node_result->field_quran_bk_code[0]['value'] ;
$titletxt = 'Surah Introduction - '.$node_result->field_surah_no[0]['value']; 
