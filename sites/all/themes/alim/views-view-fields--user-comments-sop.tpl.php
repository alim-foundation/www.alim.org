...
<?php foreach ($fields as $id => $field): ?>
 ...
 <?php if($id == 'nid' ): ?>
  ...
  <?php if($id == 'field_art_bk_code_value' ): ?>
...
if(arg(2)=="khalifa" && (arg(4)=="KUT"||arg(4)=="KAB"||arg(4)=="KUM"||arg(4)=="KAL")){
$viewName = 'Khalifa_content';
...
$viewName = 'biography_stories_content';
...
$viewName = 'biography_companions_content';
...
<?php  
 ...
 if($value=="Community User"||($value!="Community User" && $value!="Scholar" && $value!="Book Author" )) {?> <table width="100%" border="0" style="border-color:#CCCCCC;margin-bottom:20px;border:solid #A0A0A0 1px;border-collapse:separate;"  ><tr><td>
  ...
  <tr>
    <td  width="69" class="cm_image" valign="top" style="padding-top:5px;"   ><!--<img title="" src="<?php print $img_theme_path; ?>/userimage.png" />-->
