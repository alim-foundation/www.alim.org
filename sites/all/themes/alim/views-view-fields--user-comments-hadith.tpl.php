...
<a  class="rpxnow" style="text-decoration:none;font-size:11px;" onclick="return false;" href="https://alim.rpxnow.com/openid/v2/signin?token_url=<?php print $base_url; ?>/rpx/end_point"><img align="absmiddle" src="<?php print $img_theme_path; ?>/ico_reply.gif" />&nbsp;Reply</a>

<?php if(($userid)==($user->uid)){ ?> &nbsp;|&nbsp;<span style="font-size:11px;"><a href="<?php print $base_url ?>/comment/edit/<?php print $cid; ?>/comid" class="popups" on-popups-options="{reloadWhenDone: true}"  style="text-decoration:none;font-size:11px;"><img align="absmiddle" src="<?php print $img_theme_path; ?>/icon_edit_comment.png" />&nbsp;Edit</a></span><?php } ?>


&nbsp;|&nbsp;<img align="absmiddle" src="<?php print $img_theme_path; ?>/ico_flag.gif" /><a  class="rpxnow" style="text-decoration:none;font-size:11px;" onclick="return false;" href="https://alim.rpxnow.com/openid/v2/signin?token_url=<?php print $base_url; ?>/rpx/end_point">&nbsp;Report Inappropriate</a>
...
&nbsp;|&nbsp;<img align="absbottom" src="<?php print $img_theme_path; ?>/ico_email.gif" />Email this
</span>
-->
...
?></div></div>
		...
		<?php 
$rrtt="ctdef1".$cid;  $idval = 'ctdef1-'.$cid;?>
<div id="comment_reply_comm" style="margin-left:<?php print $padd.'px' ?>;padding-left:<?php print $padd1.'px' ?>;border-bottom:dotted 1px #cccccc;"  >
<?php	if ($user->uid){ ?>
